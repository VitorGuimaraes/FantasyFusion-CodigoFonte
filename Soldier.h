...
public:
   ...
   ALLEGRO_BITMAP *H3, short pos_x3, short pos_y3);			//Método da animação do personagem levando dano
	...
	ALLEGRO_BITMAP *getStop();			//Método que retorna o sprite de Soldier parado
	ALLEGRO_BITMAP *getStopInverse();
	ALLEGRO_BITMAP *getVictory();
	ALLEGRO_BITMAP *getVictoryInverse();

	ALLEGRO_BITMAP *getPortrait();		//Método que retorna o sprite do portrait de Soldier
	ALLEGRO_BITMAP *getDefend();		//Método que retorna o sprite de Soldier em modo de defesa
